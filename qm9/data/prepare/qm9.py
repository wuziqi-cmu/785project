...
def download_dataset_qm9(datadir, dataname, splits=None, calculate_thermo=True, exclude=True, cleanup=True):
    ...
    if splits is None:
        ...
        splits = my_gen_splits_gdb9(gdb9dir, splits, cleanup)
...
def my_gen_splits_gdb9(gdb9dir, init_split, cleanup=True):
    """
    Generate GDB9 training/validation/test splits used.
    ...
    if(len(extra) != 0): print('Split was inexact {} {} {} {}'.format(len(train), len(valid), len(test), len(extra)))
